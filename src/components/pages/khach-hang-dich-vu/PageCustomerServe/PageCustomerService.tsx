...
import {ICustomer, PropsPageCustomerService} from './interfaces';
...
function PageCustomerService({}: PropsPageCustomerService) {
	...
	const listCustomerStorage = useQuery([QUERY_KEY.table_khach_hang_dich_vu, _keyword, _page, _pageSize, _partnerUuid], {
		queryFn: () =>
			httpRequest({
				isList: true,
