...
import {IDetailCustomer, PropsDetailCustomerService} from './interfaces';
import styles from './DetailCustomerService.module.scss';
		...
		<div className={styles.container}>
			<div className={styles.header}>
				...
				>
					...
					<p>Chi tiết khách hàng dịch vụ {detailCustomer?.code}</p>
				</Link>
			</div>
			<div className={clsx('mt')}>
				<table className={styles.container_table}>
					...
					<tr>
						<td>
							<span>Mã khách hàng dịch vụ: </span>
							<span style={{marginLeft: '6px', color: '#2A85FF'}}>{detailCustomer?.code || '---'}</span>
						</td>
						<td>
							<span>Tên khách hàng dịch vụ: </span>
