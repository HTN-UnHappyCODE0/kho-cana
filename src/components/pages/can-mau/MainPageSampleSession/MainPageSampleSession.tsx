...
import {ISampleSession, PropsMainPageSampleSession} from './interfaces';
import styles from './MainPageSampleSession.module.scss';
...
function MainPageSampleSession({}: PropsMainPageSampleSession) {
	const router = useRouter();

	const {_page, _pageSize, _keyword, _status, _specUuid, _shipUuid, _dateFrom, _dateTo, _customerUuid, _type} = router.query;
	...
	const listSampleSession = useQuery(
		[QUERY_KEY.table_ds_can_mau, _page, _customerUuid, _type, _pageSize, _shipUuid, _keyword, _dateTo, _dateFrom, _specUuid, _status],
		{
			queryFn: () =>
				httpRequest({
					isList: true,
		...
		<div className={styles.container}>
			...
			<div className={styles.table}>
				...
				<Pagination
					...
					pageSize={Number(_pageSize) || 200}
					dependencies={[_pageSize, _keyword, _status, _specUuid, _shipUuid, _customerUuid, _dateTo, _dateFrom, _type]}
				/>
			</div>
		</div>
	);
...
export default MainPageSampleSession;
