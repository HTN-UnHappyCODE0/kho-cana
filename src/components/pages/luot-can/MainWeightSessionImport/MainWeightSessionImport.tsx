...
import {PropsMainWeightSessionImport} from './interfaces';
import styles from './MainWeightSessionImport.module.scss';
...
function MainWeightSessionImport({}: PropsMainWeightSessionImport) {
	...
	const listWeightsession = useQuery(
		[
			QUERY_KEY.table_luot_can_phieu_nhap,
			_page,
			_pageSize,
			_keyword,
			_truckUuid,
...
export default MainWeightSessionImport;
