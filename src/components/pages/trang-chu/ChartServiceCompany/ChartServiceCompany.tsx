...
function ChartServiceCompany({}: PropsChartServiceCompany) {
	...
	const listCustomer = useQuery([QUERY_KEY.dropdown_khach_hang_dich_vu, uuidCompany, listPartnerUuid, userUuid], {
		queryFn: () =>
			httpRequest({
				isDropdown: true,
	...
	const listStorage = useQuery([QUERY_KEY.dropdown_bai_dich_vu], {
		queryFn: () =>
			httpRequest({
				isDropdown: true,
	...
	const listProvince = useQuery([QUERY_KEY.dropdown_tinh_thanh_pho_dich_vu], {
		queryFn: () =>
			httpRequest({
				isDropdown: true,
	...
	const listCompany = useQuery([QUERY_KEY.dropdown_cong_ty_dich_vu], {
		queryFn: () =>
			httpRequest({
				isDropdown: true,
	...
	const listUserPurchasing = useQuery([QUERY_KEY.dropdown_quan_ly_nhap_hang_dich_vu], {
		queryFn: () =>
			httpRequest({
				isDropdown: true,
	...
	const listUserMarket = useQuery([QUERY_KEY.dropdown_nhan_vien_thi_truong_dich_vu], {
		queryFn: () =>
			httpRequest({
				isDropdown: true,
				http: userServices.listUser2({
	...
	const listPartner = useQuery([QUERY_KEY.dropdown_nha_cung_cap_dich_vu, uuidCompany, userPartnerUuid], {
		queryFn: () =>
			httpRequest({
				isDropdown: true,
	...
	useQuery(
		[
			QUERY_KEY.thong_ke_tong_hang_dich_vu,
			customerUuid,
			storageUuid,
			date,
			userUuid,
