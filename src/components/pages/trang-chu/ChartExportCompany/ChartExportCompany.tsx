...
function ChartExportCompany({}: PropsChartExportCompany) {
	...
	const listCustomer = useQuery([QUERY_KEY.dropdown_khach_hang_xuat, uuidCompany, userUuid], {
		queryFn: () =>
			httpRequest({
				isDropdown: true,
				http: customerServices.listCustomer({
	...
	const listProvince = useQuery([QUERY_KEY.dropdown_tinh_thanh_pho_xuat], {
		queryFn: () =>
			httpRequest({
				isDropdown: true,
	...
	const listCompany = useQuery([QUERY_KEY.dropdown_cong_ty_xuat], {
		queryFn: () =>
			httpRequest({
				isDropdown: true,
				http: companyServices.listCompany({
