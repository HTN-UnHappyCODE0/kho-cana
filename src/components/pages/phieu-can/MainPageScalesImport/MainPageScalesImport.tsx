...
import { PropsMainPageScalesImport } from './interfaces';
import styles from './MainPageScalesImport.module.scss';
								...
								render: (data: ITableBillScale) => (
									<div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: '4px' }}>
										...
										<IconCustom
											...
											tooltip='Chỉnh sửa'
											color='#777E90'
											href={data?.isBatch == TYPE_BATCH.KHONG_CAN ? `/nhap-xuat-ngoai/chinh-sua-nhap?_id=${data.uuid}` : `/phieu-can/chinh-sua-phieu-nhap?_id=${data.uuid}`}
										/>
...
export default MainPageScalesImport;
